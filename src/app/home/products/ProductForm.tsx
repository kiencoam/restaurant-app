...
export default function ProductForm({
  ...
  const handleSaveProduct = async () => {
    createProduct(product).then((res: ProductEntity) => {
      console.log(res);
      setGetProductRequest((prev) => ({ ...prev }));
    });
        ...
        >
          <div className="flex pt-3">
            <div className="flex items-center gap-3">
              <label htmlFor="code" className="px-2 py-4 w-28">
                Mã hàng hóa
              </label>
              <input
                id="code"
            ...
            <div className="flex items-center gap-3 pl-3">
              <label htmlFor="costPrice" className="px-2 py-4">
                Giá vốn
              </label>
              <input
                id="costPrice"
          ...
          <div className="flex">
            <div className="flex items-center gap-3">
              <label htmlFor="name" className="px-2 py-4 w-28">
                Tên hàng
              </label>
              <input
                id="name"
            ...
            <div className="flex items-center gap-3 pl-3">
              <label htmlFor="sellingPrice" className="px-2 py-4">
                Giá bán
              </label>
              <input
                id="sellingPrice"
          ...
          <div className="flex items-center gap-3">
            <label htmlFor="productType" className="font-bold mb-2">
              Loại hàng hóa
            </label>
            <select
              id="productType"
