...
import { UpdateMenuItemRequest } from "@/app/api-client/MenuItemService";
...
export default function MenuItemList({
  ...
  const handleSaveUpdate = async () => {
    ...
    setMenuItems((prev) =>
      prev.map((table) =>
        table.id === updatingMenuItemId
          ? { ...table, ...updatingMenuItem }
          : table
      )
    );
                        ...
                        <div className="flex gap-10">
                          ...
                          <div className="space-y-4">
                            <label className="w-64">
                              ...
                              <input
                                type="text"
                                value={updatingMenuItem.thumbnailUrl}
                                onChange={(e) =>
                                  setUpdatingMenuItem((prev) => ({
                                    ...prev,
                            ...
                            <div className="flex justify-center items-center">
                              <img
                                src={updatingMenuItem.thumbnailUrl}
                                alt="thumbnail"
