...
export const getDetailMenuItem = async (id: number): Promise<MenuItemEntity> => {
...
export const updateMenuItem = async (id: number, payload: UpdateMenuItemRequest): Promise<MenuItemEntity> => {
