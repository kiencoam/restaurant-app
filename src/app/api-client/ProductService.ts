...
export const createProduct = async (payload: CreateProductRequest): Promise<ProductEntity> => {
    return await apiClientService.post(baseUrl, payload).then(res => res.data);
}

export const updateProduct = async (id: number, payload: UpdateProductRequest): Promise<ProductEntity> => {
